...
export default function PharmacyBilling() {
  ...
  const filteredData = billingData.filter(transaction => {
    const matchesSearch = transaction.customerName.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         transaction.medicationName.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         transaction.prescriptionId.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-1">Track payments, insurance claims, and financial reporting</p>
        </div>
                  ...
                  <TableRow key={transaction.id}>
                    ...
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-gray-500">{transaction.prescriptionId}</div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="text-sm">{transaction.medicationName}</div>
                    </TableCell>
                    <TableCell>
                      <div>
